...
var utils = module.exports = {
  ...
  isOptionsHash: function(o) {
    return _.isPlainObject(o) && ['api_key', 'idempotency_key', 'fusebill_account'].some(function(key) {
  ...
  getOptionsFromArgs: function(args) {
    ...
    if (args.length > 0) {
      ...
      if (utils.isAuthKey(arg)) {
        ...
        if (params.fusebill_account) {
          opts.headers['Fusebill-Account'] = params.fusebill_account;
        }
      }
    }
    return opts;
